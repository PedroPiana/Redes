...
def main():
    ...
    personagem1 = Personagem(input('Digite o nome do Personagem 1: '), input('Digite a classe do Personagem 1: '))
    ...
    while not encerrado:
        ...
        jogador.send(msg.encode()) # enviar teste ou D20 e o dano, msg = 'AD' + '18' + '30' 
